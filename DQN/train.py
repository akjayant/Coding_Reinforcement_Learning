...
class Agent():
    ...
    epsilon_start,epsilon_decay,epsilon_min,update_every,batch_size):
        ...
        self.env = env
        self.device = device
        self.policy_qnet = model.DQN(self.frame_history_len,84,84,6,1e-3).to(self.device)
        self.target_qnet = model.DQN(self.frame_history_len,84,84,6,1e-3).to(self.device)
    ...
    def update_gradients(self):
        ...
        target = rewards + max_action_values*(1-dones)
